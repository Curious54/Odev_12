...
let koreaFood = menu.filter(item => item.category == "Korea");
...
let japanFood = menu.filter(item => item.category == "Japan");
...
let ChinaFood = menu.filter(item => item.category == "China");
